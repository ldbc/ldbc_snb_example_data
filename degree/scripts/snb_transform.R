...
invisible(dbExecute(con, "INSERT INTO Comment SELECT id, content, hasCreator_Person, isLocatedIn_Place, replyOf_Post, replyOf_Comment FROM Raw_Comment"))
invisible(dbExecute(con, "INSERT INTO Forum SELECT id, title, hasModerator_Person FROM Raw_Forum"))
invisible(dbExecute(con, "INSERT INTO Post SELECT id, content, hasCreator_Person, Forum_containerOf, isLocatedIn_Place FROM Raw_Post"))
invisible(dbExecute(con, "INSERT INTO Person SELECT id, firstName, lastName, isLocatedIn_Place FROM Raw_Person"))
