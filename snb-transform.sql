...
COPY (SELECT creationDate, id, title, hasModerator_Person FROM Forum)
  TO 'data/csv-composite-merged-fk/Forum.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, locationIP, browserUsed, content, length, hasCreator_Person, isLocatedIn_Place, replyOf_Post, replyOf_Comment FROM Comment)
  TO 'data/csv-composite-merged-fk/Comment.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, imageFile, locationIP, browserUsed, language, content, length, hasCreator_Person, Forum_containerOf, isLocatedIn_Place FROM Post)
  TO 'data/csv-composite-merged-fk/Post.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, firstName, lastName, gender, birthday, locationIP, browserUsed, isLocatedIn_Place, speaks, email FROM Person)
...
COPY (SELECT creationDate, id, hasTag_Tag FROM Post_hasTag_Tag)
  TO 'data/csv-composite-merged-fk/Post_hasTag_Tag.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasMember_Person FROM Forum_hasMember_Person)
  TO 'data/csv-composite-merged-fk/Forum_hasMember_Person.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasTag_Tag FROM Forum_hasTag_Tag)
  TO 'data/csv-composite-merged-fk/Forum_hasTag_Tag.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasInterest_Tag FROM Person_hasInterest_Tag)
  TO 'data/csv-composite-merged-fk/Person_hasInterest_Tag.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, likes_Comment FROM Person_likes_Comment)
  TO 'data/csv-composite-merged-fk/Person_likes_Comment.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, likes_Post FROM Person_likes_Post)
  TO 'data/csv-composite-merged-fk/Person_likes_Post.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, studyAt_University, classYear FROM Person_studyAt_University)
  TO 'data/csv-composite-merged-fk/Person_studyAt_University.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, workAt_Company, workFrom FROM Person_workAt_Company)
  TO 'data/csv-composite-merged-fk/Person_workAt_Company.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, Person1id, Person2id FROM Person_knows_Person)
...
COPY (SELECT creationDate, id, firstName, lastName, gender, birthday, locationIP, browserUsed, isLocatedIn_Place FROM Person)
...
COPY (SELECT creationDate, id, title FROM Forum)
  TO 'data/csv-composite-projected-fk/Forum.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasModerator_Person FROM Forum)
  TO 'data/csv-composite-projected-fk/Forum_hasModerator_Person.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, locationIP, browserUsed, content, length FROM Comment)
  TO 'data/csv-composite-projected-fk/Comment.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasCreator_Person FROM Comment)
  TO 'data/csv-composite-projected-fk/Comment_hasCreator_Person.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, isLocatedIn_Place FROM Comment)
  TO 'data/csv-composite-projected-fk/Comment_isLocatedIn_Place.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, replyOf_Post FROM Comment)
  TO 'data/csv-composite-projected-fk/Comment_replyOf_Post.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, replyOf_Comment FROM Comment)
  TO 'data/csv-composite-projected-fk/Comment_replyOf_Comment.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, imageFile, locationIP, browserUsed, language, content, length FROM Post)
  TO 'data/csv-composite-projected-fk/Post.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, hasCreator_Person FROM Post)
  TO 'data/csv-composite-projected-fk/Post_hasCreator_Person.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, Forum_containerOf FROM Post)
  TO 'data/csv-composite-projected-fk/Post_Forum_containerOf.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, isLocatedIn_Place FROM Post)
  TO 'data/csv-composite-projected-fk/Post_isLocatedIn_Place.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, firstName, lastName, gender, birthday, locationIP, browserUsed FROM Person)
  TO 'data/csv-composite-projected-fk/Person.csv'
  WITH (HEADER, DELIMITER '|');

COPY (SELECT creationDate, id, isLocatedIn_Place FROM Person)
